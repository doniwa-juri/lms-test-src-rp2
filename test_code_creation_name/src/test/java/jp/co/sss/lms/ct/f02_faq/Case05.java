...
public class Case05 {
	...
	void test01() throws Exception {
		...
		FileUtils.copyFile(file, new File("evidence\\case05\\test01.png"));
	}
	...
	void test02() throws Exception {
		...
		File file = ((TakesScreenshot) webDriver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(file, new File("evidence\\case05\\test02.png"));
	}
	...
	void test03() throws Exception {
		...
		File file = ((TakesScreenshot) webDriver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(file, new File("evidence\\case05\\test03.png"));
	}
	...
	void test04() throws Exception {
		...
		File file = ((TakesScreenshot) webDriver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(file, new File("evidence\\case05\\test04.png"));
	}
	...
	void test05() throws Exception {
		...
		FileUtils.copyFile(file1, new File("evidence\\case05\\test05(1).png"));
		...
		FileUtils.copyFile(file2, new File("evidence\\case05\\test05(2).png"));
	...
	void test06() throws Exception {
		...
		File file = ((TakesScreenshot) webDriver).getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(file, new File("evidence\\case05\\test06.png"));
